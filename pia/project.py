...
benchmark_symbols = ['BTC/USDT', 'ETH/USDT', 'BNB/USDT']
timeframe = '4h'
...
class CrossAssetTradingSystem:
    ...
    def calculate_cross_features(self, df):
        ...
        benchmark_symbols = ['BTC/USDT', 'ETH/USDT']  # Asumidos de contexto anterior
        ...
        self.raw_columns = [
            ...
            *[f'{base}_close' for base in ['BTC', 'ETH']],
            *[f'{base}_ma_50_raw' for base in ['BTC', 'ETH']],
            *[f'{base}_ma_200_raw' for base in ['BTC', 'ETH']],
            *[f'{base}_corr_24h_raw' for base in ['BTC', 'ETH']],
            *[f'{base}_volatility_24h' for base in ['BTC', 'ETH']]
        ]
    ...
    def compute_correlation_matrix(self, df):
        ...
        cols = ['SOL_close', 'BTC_close', 'ETH_close']
...
def main():
    ...
    market_data = df[['SOL_close', 'SOL_open', 'SOL_high', 'SOL_low', 'SOL_close', 'SOL_volume', 'SOL_rsi_14h', 'SOL_atr_raw', 'BTC_ma_50_raw', 'BTC_ma_200_raw']].reset_index()
